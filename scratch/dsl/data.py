...
def insert_at_list(
    list_: str, item: int | float | str | Reporter, index: int | float | Reporter = 1
) -> StackExpr:
    """``data_insertatlist``."""
...
def replace_item_of_list(
    list_: str, index: int | float | Reporter, item: int | float | str | Reporter
) -> StackExpr:
